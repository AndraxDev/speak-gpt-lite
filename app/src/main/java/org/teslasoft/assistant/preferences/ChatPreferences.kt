...
class ChatPreferences private constructor() {
    ...
    fun clearChat(context: Context, chatId: String) {
        EncryptedPreferences.setEncryptedPreference(context, "chat_$chatId", "chat", "[]")
    }
    ...
    fun deleteChat(context: Context, chatName: String) {
        ...
        EncryptedPreferences.setEncryptedPreference(context, "chat_list", "data", json)
        EncryptedPreferences.setEncryptedPreference(context, "chat_${Hash.hash(chatName)}", "chat", "[]")
    }
    ...
    fun getChatList(context: Context) : ArrayList<HashMap<String, String>> {
        val gson = Gson()
        val json = EncryptedPreferences.getEncryptedPreference(context, "chat_list", "data", "[]")
    ...
    fun getChatById(context: Context, chatId: String) : ArrayList<HashMap<String, Any>> {
        var list: ArrayList<HashMap<String, Any>> = try {
            val gson = Gson()
            val json = EncryptedPreferences.getEncryptedPreference(context, "chat_$chatId", "chat", "[]")
            val type: Type = TypeToken.getParameterized(ArrayList::class.java, HashMap::class.java).type
    ...
    fun getChatByIdAsString(context: Context, chatId: String) : String {
        return EncryptedPreferences.getEncryptedPreference(context, "chat_$chatId", "chat", "[]")
    }
    ...
    fun editMessage(context: Context, chatId: String, position: Int, newMessage: String) {
        ...
        val json: String = Gson().toJson(list)
        EncryptedPreferences.setEncryptedPreference(context, "chat_$chatId", "chat", json)
    }
    ...
    fun editChat(context: Context, chatName: String, previousName: String) {
        ...
        for (map: HashMap<String, String> in list) {
            if (map["id"] == Hash.hash(previousName)) {
                ...
                EncryptedPreferences.setEncryptedPreference(context, "chat_list", "data", json)
                val str = EncryptedPreferences.getEncryptedPreference(context, "chat_${Hash.hash(previousName)}", "chat", "[]")
                EncryptedPreferences.setEncryptedPreference(context, "chat_${Hash.hash(chatName)}", "chat", str)
                EncryptedPreferences.setEncryptedPreference(context, "chat_${Hash.hash(previousName)}", "chat", "[]")
                break
            }
        }
    }
