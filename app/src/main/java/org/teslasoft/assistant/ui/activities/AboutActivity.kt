...
class AboutActivity : FragmentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tidVer?.text = "${getString(R.string.teslasoft_id_version)} Not present"
        ...
        btnPrivacy?.setOnClickListener {
            val i = Intent()
            i.data = "https://${Config.API_SERVER_NAME}/privacy_lite".toUri()
            i.action = Intent.ACTION_VIEW
            startActivity(i)
        }
        ...
        btnDonate?.setOnClickListener {
            val i = Intent()
            i.data = "https://buymeacoffee.com/andrax_dev".toUri()
            i.action = Intent.ACTION_VIEW
            startActivity(i)
        }
